...
@PageTitle("Form Filler For Receipt")
@Route(value = "receipt", layout = MainLayout.class)
public class FormFillerReceiptDocDemo extends VerticalLayout {
